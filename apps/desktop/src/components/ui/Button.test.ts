...
describe("Button", () => {
  ...
  it("maps primary variant to default styles", () => {
    const primary = mount(Button, { props: { variant: "primary" }, slots: { default: "x" } });
    const explicit = mount(Button, { props: { variant: "default" }, slots: { default: "x" } });
  ...
  it("maps md size to default styles", () => {
    ...
    const def = mount(Button, { props: { size: "default" }, slots: { default: "x" } });
